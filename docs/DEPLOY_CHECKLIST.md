...
- [ ] 승인 전: 광고 자리가 완전히 숨겨져 있는지 확인 (FEATURE_ADS=false 상태가 정상)
- [ ] 승인 후: ① `index.html`의 FEATURE_ADS를 true로 변경 ② 광고 단위 slot 3개를 `data-ad-slot` 값에 교체
...
- [ ] 애드센스 심사 요청 → 승인 후 FEATURE_ADS=true + slot 교체
